...
namespace DependenciesHunter
{
    ...
    public class SelectedAssetsReferencesWindow : EditorWindow
    {
        ...
        private bool _foldableDependencies = false;
        ...
        public static void FindReferences(SelectedAssetsAnalysisUtilities service)
        {
        ...
        public void SetService(SelectedAssetsAnalysisUtilities service)
        {
            _service = service;
        }
        ...
        private void OnGUI()
        {
            ...
            for (var i = 0; i < _selectedObjectsFoldouts.Length; i++)
            {
                ...
                var content = dependencies.Count > 0 ? $"Target used: {dependencies.Count}" : "No target found";
            ...
            _foldableDependencies = EditorGUILayout.Foldout(_foldableDependencies, "Build from(dependencies):");
            if (_foldableDependencies)
            {
                var selectedObj = _selectedObjects[0];
